...
$("body").on("click", ".addTitle", function(){
 ...
 var BookInput= $(this).parent().children()[1].value
  ...
  $(this).parent().html("<div class='col-auto col-md-4'>'><img class='haveRead' src='images/greenBook.png'><div class=BooksIHaveRead>" + BookInput + "</div><div class='deleteBook' >DeleteBook</div></div>");
})
